...
<body>
        ...
        <div class="container">
            <div class="header-content">
                ...
                <div class="nav-actions">
                    <div class="btn btn-secondary">Sign In</div>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <div class="btn btn-primary btn-large">Get Started</div>
    ...
    <section class="cta">
        <div class="container">
            ...
            <div class="hero-actions">
                <div class="btn btn-primary btn-large">Contact Us</div>
                <div class="btn btn-secondary">Explore Features</div>
            </div>
        </div>
    </section>
