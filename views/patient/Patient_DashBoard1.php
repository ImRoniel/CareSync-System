        ...
        <div class="container">
            <div class="dashboard-header">
                <div>
                    ...
                    <p>Welcome back, <?= htmlspecialchars($patient2['name'] ?? 'no name found.' ) ?></p>
                </div>
                <div class="user-info">
                    <div class="user-avatar"><?= strtoupper(substr($patient2['name'], 0, 2)) ?></div>
                    <div>
                        <p><?= htmlspecialchars($patient2['name']) ?></p>
                        <small>Patient ID: <?= htmlspecialchars($patient2['patient_id']) ?></small>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3><?php echo htmlspecialchars($upcomingAppointmentsCount); ?></h3>
