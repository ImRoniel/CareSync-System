...
if (!$include) {
    echo $error_message = "<!-- Error: Could not include db_connect.php -->";
    exit();
}
    ...
    <section class="dashboard">
        <div class="container">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card" onclick="showTab('doctors')">
                ...
                <div class="stat-card" onclick="showTab('patients')">
                ...
                <div class="stat-card" onclick="showTab('appointments')">
                    ...
                    <div class="card">
                                        ...
                                        <?php if($resultSystemOver->num_rows > 0): ?>
                                            <?php while ($row = $resultSystemOver->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-secondary" onclick="editUser('<?= htmlspecialchars($row['name']); ?>')">Edit</button>
                                                        <button class="btn btn-sm btn-danger" onclick="deactivateUser('<?= htmlspecialchars($row['name']); ?>')">Deactivate</button>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        <?php else: ?>
                        ...
                        <div class="tab-content" id="doctors">
                            ...
                            <div class="user-management-grid">
                                <div class="user-card" onclick="viewDoctor('Dr. Name Here')">
                                    <div class="user-avatar-large">NH</div>
                                    <div class="user-details">
                                        <h3>Dr. Name Here</h3>
                                        <p>Specialization Here</p>
                                        <p>email@caresync.com</p>
                                        <p><span class="status-badge status-active">Active</span></p>
                                    </div>
                                    <div class="user-actions">
                                        <button class="btn btn-sm btn-secondary" onclick="event.stopPropagation(); editDoctor('Dr. Name Here')">Edit</button>
                                        <button class="btn btn-sm btn-info" onclick="event.stopPropagation(); viewSchedule('Dr. Name Here')">Schedule</button>
                                    </div>
                                </div>
                                ...
                                <div class="user-card" onclick="viewDoctor('Dr. Name Here')">
                                    ...
                                    <div class="user-actions">
                                        <button class="btn btn-sm btn-secondary" onclick="event.stopPropagation(); editDoctor('Dr. Name Here')">Edit</button>
                                        <button class="btn btn-sm btn-primary" onclick="event.stopPropagation(); approveDoctor('Dr. Name Here')">Approve</button>
                                    </div>
                                </div>
