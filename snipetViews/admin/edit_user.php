...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: /Caresync-System/dashboard/admin_dashboard.php"); // Redirect back to user list
        exit;
    } else {
        ...
        <div class="edit-form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-actions">
                    <a href="../../dashboard/admin_dashboard.php" class="cancel-btn">Cancel</a>
